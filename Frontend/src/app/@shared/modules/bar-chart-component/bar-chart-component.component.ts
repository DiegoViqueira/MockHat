...
@Component({
  selector: 'wlk-bar-chart-component',
  templateUrl: './bar-chart-component.component.html',
  styleUrl: './bar-chart-component.component.scss',
  standalone: false
})
export class BarChartComponentComponent implements AfterViewInit, OnChanges, OnInit {
  ...
  public barChartData: ChartData<'bar'> = { labels: [], datasets: undefined };
  ...
  parseChartData(): ChartData<'bar'> | undefined {
    if (this.datasets) {
